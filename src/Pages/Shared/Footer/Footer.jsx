      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
        <div className="flex flex-col flex-shrink-0">
          ...
          <p className="text-xs leading-none text-gray-800 mt-4">
            Copyright &copy; {copyrightYears} Reuse and Reduce
          </p>
          <p className="text-xs leading-none text-gray-800 mt-4">
            All rights reserved
          </p>
          <div className="flex items-center gap-x-4 mt-12">
            <div className="opacity-90 w-8 text-white h-8 flex-shrink-0 bg-baseColor cursor-pointer hover:bg-secondaryColor transition-all duration-150 rounded-full flex items-center justify-center">
