...
const Contact = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Contact - Reuse and Reduce</title>
      </Helmet>
      ...
      <div class="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
          ...
          <div class="mt-8 text-center">
            ...
            >
              <defs>
                ...
                <linearGradient id="a964f849-fa65-4178-8cc4-fb8fb10b3617" />
              </defs>
        ...
        <form ref={form} onSubmit={handleSubmit(handleContactForm)}>
          <div>
            <span class="text-sm text-gray-600 font-bold">Full Name</span>
            <input
              {...register("fullName", {
          ...
          <div class="mt-3">
            <span class="text-sm text-gray-600 font-bold">Email</span>
            <input
              {...register("email", {
          ...
          <div class="mt-3">
            <span class="text-sm text-gray-600 font-bold">Subject</span>
            <input
              {...register("subject", {
          ...
          <div class="mt-8">
            <button class="uppercase text-sm font-bold tracking-wide bg-primaryColor text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
              Send Message
            </button>
          </div>
        </form>
